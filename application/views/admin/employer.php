                ...
                <div class="x_panel">
                    ...
                    <?php } ?>
                         ...
                         <form class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url();?>admin/insert_package">
                            ...
                            <span class="section">Employer Platform Info</span>
                            ...
                            <div class="item form-group">
                                ...
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> Time of Day <span class="required"></span>

                                </label>

                                <div class="col-md-6 col-sm-6 col-xs-12">

                                    <input  class="form-control col-md-7 col-xs-12" name="title" placeholder="Enter Time" required="required" type="text">
