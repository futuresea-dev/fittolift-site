...
-->
                  ...
                  <div class="x_content">
                    ...
                    <div class="row">
                        ...
                        echo form_open("admin/searchClinic", $attr);?>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo base_url(). "admin/clinics"; ?>" class="btn btn-primary">Show All</a>
                                </div>
                            </div>
                        <?php echo form_close(); ?>
                        </div>
...
-->
    ...
    <script type="text/javascript">
        ...
        {
            if(confirm('Do you want to Delete this clinic ?'))
            {
        ...
        {
            if(confirm('Do you want to In-Active this clinic ?'))
            {
                window.location.href=url;
            }
        }
        ...
        {
            if(confirm('Do you want to Active this clinic ?'))
            {
                window.location.href=url;
            }
        }
        ...
        {
            if(confirm('Do you want to Un-Assign this Employer of clinic ?'))
            {
                window.location.href=url;
            }
        }
