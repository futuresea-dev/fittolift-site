                ...
                <div class="x_panel">
                    ...
                    <?php } ?>
                         ...
                         <form class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url();?>admin/insert_package">
                            ...
                            <span class="section">WS Platform Info</span>
                            ...
                            <div class="item form-group">
                                ...
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> Were they the 1st provider seen <span class="required"></span>
                            ...
                            <div class="item form-group">
                                ...
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> Is this employee fit for duty <span class="required"></span>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <select class="form-control col-md-7 col-xs-12">
                                      <option value="volvo">Fit for Duty</option>
                                      <option value="saab">Medical Hold</option>
                                      <option value="vw">Job Description Reviewed (required)</option>
                                    </select>
                            ...
                            <div class="item form-group">
                                ...
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nature of Injury <span class="required"></span>

                                </label>

                                <div class="col-md-6 col-sm-6 col-xs-12">

                                    <input id="name" class="form-control col-md-7 col-xs-12" name="title" placeholder="" required="required" type="text">
                            ...
                            <div class="item form-group">
                                ...
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Accident Description <span class="required"></span>
                            ...
                            <div class="item form-group">
                                ...
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Written JD reviewed <span class="required"></span>
                            ...
                            <div class="item form-group">
                                ...
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Evaluating Doctor's Name <span class="required"></span>
                            ...
                            <div class="item form-group">
                                ...
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Limitations <span class="required"></span>
